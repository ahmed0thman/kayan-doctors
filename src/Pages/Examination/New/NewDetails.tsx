          ...
          <div className="col-12 col-md-6 col-xl-3">
            <div className="form-group">
              ...
              <input
                ...
                className="form-control"
                value={bloodPressure}
                onChange={(e) => setBloodPressure(Number(e.currentTarget.value))}
              />
            </div>
          </div>
          <div className="col-12 col-md-6 col-xl-3">
            ...
            <div className="col-12 col-lg-4 pe-0">
              <div className="form-group">
                <input
                  ...
                  placeholder="random"
                  value={sugarRandom}
                  onChange={(e) => setSugarRandom(Number(e.currentTarget.value))}
                />
              </div>
            </div>
            <div className="col-12 col-lg-4 pe-0">
              <div className="form-group">
                <input
                  ...
                  onChange={(e) => setSugarBreakfast(Number(e.currentTarget.value))}
                />
              </div>
            </div>
            <div className="col-12 col-lg-4 pe-0">
              <div className="form-group">
                <input
                  ...
                  placeholder="fasting"
                  value={sugarFasting}
                  onChange={(e) => setSugarFasting(Number(e.currentTarget.value))}
                />
              </div>
            </div>
          </div>
              ...
              <div className="col-12 col-md-6 col-xl-3">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setNumberOfPregnancies(Number(e.currentTarget.value))}
                  />
                </div>
              </div>
              <div className="col-12 col-md-6 col-xl-3">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setNumberOfNaturalBirths(Number(e.currentTarget.value))}
                  />
                </div>
              </div>
              <div className="col-12 col-md-6 col-xl-3">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setNumberOfCesareanSections(Number(e.currentTarget.value))}
                  />
                </div>
              </div>
              <div className="col-12 col-md-6 col-xl-3">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setNumberOfMiscarriages(Number(e.currentTarget.value))}
                  />
                </div>
              </div>
            </>

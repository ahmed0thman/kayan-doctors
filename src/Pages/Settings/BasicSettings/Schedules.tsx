...
const Schedules = () => {
  const [scheduleStartTime, setScheduleStartTime] = useState<Date | null>(
    new Date()
  );
  const [scheduleEndTime, setScheduleEndTime] = useState<Date | null>(
    new Date()
  );
  ...
  return (
    <section className="setting-card">
      <h4 className="heading">Add Schedule</h4>
          ...
          <div className="col-12 col-lg-4">
            <div className="form-group">
              ...
              <input
                ...
                value={format(scheduleStartTime as Date, "hh:mm a")}
          ...
          <div className="col-12 col-lg-4">
            <div className="form-group">
              ...
              <input
                ...
                id="endTime"
                className="form-control"
                value={format(scheduleEndTime as Date, "hh:mm a")}
                placeholder="Please select the time"
              />
              <LocalizationProvider
                dateAdapter={AdapterDateFns}
      ...
      <button className="btn btn-primary btn-submit">Add New</button>

      <h4 className="heading mt-5">Schedules List</h4>
